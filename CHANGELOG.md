...
## [14.0.0](https://github.com/eagleeye12345/YouTub-server.js/compare/v13.1.0...v14.0.0) (2025-02-28)
...
* Add `WEB_EMBEDDED` client ([#756](https://github.com/eagleeye12345/YouTub-server.js/issues/756)) ([eaf218f](https://github.com/eagleeye12345/YouTub-server.js/commit/eaf218f5da758fc37d71f7d00ba9e42533194f8a))
...
* **Channel:** Add `getCourses` method ([#883](https://github.com/eagleeye12345/YouTub-server.js/issues/883)) ([b3a4862](https://github.com/eagleeye12345/YouTub-server.js/commit/b3a48621518f09d1ce309071499d9626cc1a8488))
...
* **CommentView:** Parse `prepareAccountCommand` ([d0d48bf](https://github.com/eagleeye12345/YouTub-server.js/commit/d0d48bf525cc2a95dd3397a3142bea113ea9782e))
...
* **FormatUtils:** choose more specific format by itag or codec ([#884](https://github.com/eagleeye12345/YouTub-server.js/issues/884)) ([1c1577e](https://github.com/eagleeye12345/YouTub-server.js/commit/1c1577e85fd46cbfa15bcee6531d9aafdda787e5))
...
* **parser:** `Add AnimatedThumbnailOverlayView` ([#903](https://github.com/eagleeye12345/YouTub-server.js/issues/903)) ([0cb92d9](https://github.com/eagleeye12345/YouTub-server.js/commit/0cb92d9620c13bf6b719b384f917ad2a658e15b1))
...
* **parser:** Add `ChangeEngagementPanelVisibilityAction` ([c2b2d7a](https://github.com/eagleeye12345/YouTub-server.js/commit/c2b2d7ad52d2cdd1d721ae4569fb6f8cb0540476))
...
* **parser:** Add `PageHeader` ([#450](https://github.com/eagleeye12345/YouTub-server.js/issues/450)) ([18cbc8c](https://github.com/eagleeye12345/YouTub-server.js/commit/18cbc8c038ddddffa1ba1519e56a8054b2996e42))
...
* **parser:** Support LockupView and it's child nodes ([#609](https://github.com/eagleeye12345/YouTub-server.js/issues/609)) ([7ca2a0c](https://github.com/eagleeye12345/YouTub-server.js/commit/7ca2a0c3e43ebd4b9443e69b7432f302b09e9c7a))
...
* **Session:** Add `IOS` to `ClientType` enum ([22a38c0](https://github.com/eagleeye12345/YouTub-server.js/commit/22a38c0762499de74f0aeb3ef01332f893518b08))
...
* **VideoInfo:** Add live stream `end_timestamp` ([#571](https://github.com/eagleeye12345/YouTub-server.js/issues/571)) ([562e6a2](https://github.com/eagleeye12345/YouTub-server.js/commit/562e6a20f06ef5302af427861355215630d91edc))
...
* **dependencies:** Update `jintr` to version 3.2.1 ([02dfcae](https://github.com/eagleeye12345/YouTub-server.js/commit/02dfcae612dd528ce4f1f3f6c62ceefd02a5c790))
...
* **DialogView:** Type mismatch ([#897](https://github.com/eagleeye12345/YouTub-server.js/issues/897)) ([b731db8](https://github.com/eagleeye12345/YouTub-server.js/commit/b731db86c51ba292c848272f28b5a9aa2e2a6956))
...
* **FlexibleActionsView:** Update actions array type to include `ToggleButtonView` ([040a091](https://github.com/eagleeye12345/YouTub-server.js/commit/040a09163903b914f546d5083dbfdeab7175b24c))
...
* **Format:** Parse xtags from protobuf to support SABR-only responses ([#909](https://github.com/eagleeye12345/YouTub-server.js/issues/909)) ([00c199a](https://github.com/eagleeye12345/YouTub-server.js/commit/00c199ac69bc6d7be19aeae04a245f30b64272c2))
* **FormatUtils:** itag matching ([#886](https://github.com/eagleeye12345/YouTub-server.js/issues/886)) ([774b3a7](https://github.com/eagleeye12345/YouTub-server.js/commit/774b3a75244db85ceb7b00f658dc2dfeb2eb4e7e))
...
* **innertube:** Allowing `getStreamingData` to use client ([#895](https://github.com/eagleeye12345/YouTub-server.js/issues/895)) ([5aecd0a](https://github.com/eagleeye12345/YouTub-server.js/commit/5aecd0ace96c371f0b15cdc6e45ef09beb5696af))
* **Innertube:** Properly encoded params in getPost() ([#882](https://github.com/eagleeye12345/YouTub-server.js/issues/882)) ([7d5c972](https://github.com/eagleeye12345/YouTub-server.js/commit/7d5c972c98d7c69b0b687b241c652f3098907a9f))
...
* **music#getPlaylist:** Handle `ContinuationItem` nodes ([a3fafe2](https://github.com/eagleeye12345/YouTub-server.js/commit/a3fafe2f7979313906dbaf1a7f9779f411266d6b)), closes [#904](https://github.com/eagleeye12345/YouTub-server.js/issues/904)
...
* **package:** Use `jsr:@luanrt/jintr` on Deno ([d9ec23c](https://github.com/eagleeye12345/YouTub-server.js/commit/d9ec23c73ca4f370df45926206a2ff070bb6552f))
...
* **Parser:** Add `UpdateEngagementPanelContentCommand` ([3f960ef](https://github.com/eagleeye12345/YouTub-server.js/commit/3f960effa24c3b14fa3c6aadf4c7badf0ac965c9))
...
* **Playlist:** is_editable ([#894](https://github.com/eagleeye12345/YouTub-server.js/issues/894)) ([2b42199](https://github.com/eagleeye12345/YouTub-server.js/commit/2b4219959cbbb27cd80788e66b608fdeed3a1f1e))
* **Playlist:** Only try extracting the subtitle for the first page ([#465](https://github.com/eagleeye12345/YouTub-server.js/issues/465)) ([e370116](https://github.com/eagleeye12345/YouTub-server.js/commit/e3701160928e9e959b88ca215c6b0a44c70ca6e6))
...
* **toDash:** Fix dash.js 4.x compatibility ([#765](https://github.com/eagleeye12345/YouTub-server.js/issues/765)) ([5ff30e1](https://github.com/eagleeye12345/YouTub-server.js/commit/5ff30e12ded29afff5a758cbe96ac3418e6d20aa))
...
* "fix(toDash): Fix default audio stream for dubbed movie trailers ([#858](https://github.com/eagleeye12345/YouTub-server.js/issues/858))" ([#896](https://github.com/eagleeye12345/YouTub-server.js/issues/896)) ([4325717](https://github.com/eagleeye12345/YouTub-server.js/commit/432571769ebc6634c2c9a4c1b5e53cfbbd2a5f0a))
